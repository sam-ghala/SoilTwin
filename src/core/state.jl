...
mutable struct SoilMoistureState
    profile::SoilTwin.AbstractMoistureProfile
    t::Float64
    top_flux::Float64
    bottom_flux::Float64
    function SoilMoistureState(profile::SoilTwin.AbstractMoistureProfile; t::Float64=0.0, top_flux::Float64=0.0, bottom_flux::Float64=0.0)
...
"""
function update!(state::SoilMoistureState; profile = nothing, t::Float64=nothing, top_flux::Float64=nothing, bottom_flux::Float64=nothing)
    t !== nothing && (state.t = t)
